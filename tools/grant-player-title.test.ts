...
function buildFixture() {
  return {
    ...
    titles: [
      ...
      { key: 'ALL_IN_ONE', label: '全图征服', category: 'c', condition: 'd', availability: 'active', displayExpr: '"a"', colorExpr: 'breathPalette.red' },
      { key: 'SKY', label: '全图主宰', category: 'c', condition: 'd', availability: 'active', displayExpr: '"a"', colorExpr: 'breathPalette.purple' },
