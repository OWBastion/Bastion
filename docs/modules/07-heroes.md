...
- 英雄设置：`settings/team_rules.opy`、`settings/all_teams.opy`
...
- `lifeweaver.opy`
  - 仅为未通关且拥有同步称号的玩家启用生命之握；花瓣平台自动回收
...
- 调整 Workshop 的英雄参数时，优先维护 `settings/team_rules.opy` 或 `settings/all_teams.opy`；main、dev 与 en-US 入口当前使用同一组英雄设置。
